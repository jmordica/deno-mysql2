...
export type { ErrnoException } from "node:internal/errors";
...
import { genfun } from "https://deno.land/x/jmordica_is_property@v1.0.1/mod.ts";
import * as seq_queue from "https://deno.land/x/jmordica_seq_queue@v1.0.1/mod.ts";
// node
